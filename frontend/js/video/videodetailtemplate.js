    ...
    const videoDetailTemplate =
        ...
        <div class="form-group row">
            <div class="col-md-12">
                ...
                ${authorArea}
                <button id="btn-like" type="button" class="btn btn-rounded btn-icon bg-transparent"> 
            <img width="13px" height="13px" style="margin-right:2px" src="./images/default/like.png" alt="">
